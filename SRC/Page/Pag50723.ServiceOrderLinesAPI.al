page 50723 ServiceOrderLinesAPI
{
    APIGroup = 'SJSI';
    APIPublisher = 'SJSI';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'serviceOrderLinesAPI';
    DelayedInsert = true;
    EntityName = 'ServiceOrderLinesAPI';
    EntitySetName = 'ServiceOrderLinesAPI';
    PageType = API;
    ...
    begin
        ...
        // ServOrderAlloc.Init();
        // ServOrderAlloc."Document No." := Rec."Document No.";
        // ServOrderAlloc."Document Type" := Rec."Document Type";
        // ServOrderAlloc."Service Item Line No." := Rec."Line No.";
        // ServOrderAlloc."Service Item No." := rec."Item No.";
        // ServOrderAlloc.Insert();
    end;
}
