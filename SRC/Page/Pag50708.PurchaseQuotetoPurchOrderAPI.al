page 50708 PurchaseQuotetoPurchOrderAPI
{
    APIGroup = 'SJSI';
    APIPublisher = 'SJSI';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'purchaseQuotetoPurchOrderAPI';
    DelayedInsert = true;
    EntityName = 'purchaseQuotetoPurchOrderAPI';
    EntitySetName = 'purchaseQuotetoPurchOrderAPI';
    PageType = API;
    ...
    begin
        if ApprovalsMgmt.PrePostApprovalCheckPurch(Rec) then begin
            CODEUNIT.Run(CODEUNIT::"Purch QuotetoOrder customized", Rec);
        end;
    end;
}
