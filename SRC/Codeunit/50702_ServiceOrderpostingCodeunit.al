codeunit 50702 "Service-Post (Yes/No) modified"
{
    ...
    var
        ServicePost: Codeunit "Service-Post modified";
        Ship: Boolean;
        Consume: Boolean;
        Invoice: Boolean;
        HideDialog: Boolean;
    ...
    begin
        ...
        OnAfterConfirmPost(PassedServiceHeader, PassedServiceHeader.Ship, PassedServiceHeader.Consume, PassedServiceHeader.Invoice);

        //ServicePost.SetPreviewMode(PreviewMode);
        ServicePost.PostWithLines(PassedServiceHeader, PassedServLine, PassedServiceHeader.Ship, PassedServiceHeader.Consume, PassedServiceHeader.Invoice);
