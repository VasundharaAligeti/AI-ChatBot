codeunit 50703 "Production JournalMgt Modified"
{
...
#pragma warning restore AA0074
    ...
    var
        ...
        LeaveForm: Boolean;
        IsHandled: Boolean;
        "Released Prod. Order Lines": page "Released Prod. Order Lines";
    begin
        IsHandled := false;
        ...
        if not IsHandled then begin
            ...
            if ProdOrder.Isconsumption then
                CreateJnlLinesforConsumption(ProdOrder, ActualLineNo);
            if ProdOrder.IsOutput then
    ...
    procedure CreateJnlLinesforConsumption(ProdOrder: Record "Production Order"; ProdOrderLineNo: Integer)
    var
        ItemJnlLine: Record "Item Journal Line";
        ProdOrderLine: Record "Prod. Order Line";
        ProdOrderRtngLine: Record "Prod. Order Routing Line";
    ...
    begin
        ...
        if ProdOrderComp."Flushing Method" <> ProdOrderComp."Flushing Method"::"Pick + Manual" then
            NeededQty := 0
        else
            NeededQty := ProdOrderComp.GetNeededQty(CalcBasedOn, true);
