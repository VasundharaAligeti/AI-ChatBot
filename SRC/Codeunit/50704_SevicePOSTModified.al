...
codeunit 50704 "Service-Post Modified"
{
...
#pragma warning restore AA0074
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            InsertServiceInvoiceCFDIRelations(ServiceHeader, ServInvoiceNo);
            InsertServiceCreditMemoCFDIRelations(ServiceHeader, ServCrMemoNo);
