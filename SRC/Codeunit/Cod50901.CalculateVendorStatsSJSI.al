codeunit 50901 CalculateVendorStatsSJSI
{
    trigger OnRun()
    var
    ...
    procedure GetLastPaymentDateLabel(): Text
    begin
        exit(LastPaymentDateLbl);
    end;

    procedure GetOverdueBalanceLabel(): Text
    begin
        exit(OverdueBalanceLbl);
    end;

    procedure GetInvoicedPrepmtAmountLCYLabel(): Text
    begin
        exit(InvoicedPrepmtAmountLCYLbl);
    end;

    procedure GetVendorNoLabel(): Text
    begin
        exit(VendorNoLbl);
    end;

    procedure GetBalanceAsCustomerLabel(): Text
    begin
        exit(BalanceAsCustomerLbl);
    end;

    procedure GetLinkedCustomerNoLabel(): Text
    begin
